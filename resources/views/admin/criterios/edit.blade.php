<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <x-heroicon-o-pencil-square class="w-7 h-7 text-amber-600" />
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">
                    Actualizar información del criterio de evaluación
                </p>
            </div>
        </div>
    </x-slot>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="descripcion"
                                      rows="4"
                                      class="w-full border-gray-300 rounded-xl focus:border-amber-500 focus:ring-amber-500">{{ old('descripcion', $criterio->descripcion) }}</textarea>
                        ...
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-amber-600">
                                    Si modificas el puntaje máximo, las futuras evaluaciones respetarán este nuevo límite.
                                </p>
                            </div>
                        </div>
                    </div>
